...
function Report() {
  ...
  const sectorOptions = [
    'Pick a sector here', 'Women', 'Men', 'Families', 'Co-ed', 'Youth'
  ];
  ...
  return (
    ...
    <p>Pick dates above and an option below</p>
    ...
    <p>Once you click on the button it might look like nothings happening, especially if you select a large date range.<br/> Give it up to 10 seconds to work before trying again (or letting me know). 
